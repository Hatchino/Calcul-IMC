...
if (imc < 18.5) {
    alert("Selon votre IMC, vous être trop maigre");
} else if ((imc >= 18.5) && (imc <= 24.9)) {
    alert("Selon votre IMC, vous être normal");
} else if ((imc >= 25) && (imc <= 29.9)) {
    alert("Selon votre IMC, vous être en surpoids");
} else if ((imc >= 30) && (imc <= 34.9)) {
    alert("Selon votre IMC, vous être obèse");
} else if (imc >= 35) {
    alert("Selon votre IMC, vous être en obésité sévère");
}
